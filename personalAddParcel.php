<?php
	...
	$query = "Insert Into parcelinformation (id, trackingnum, name, nophone, dateArrive, courier, statusParcel) Values (' ','$trackingno','$name','$numphone','$dateArrive', '$courier', '$statusParcel')";
	...
	<div class="main">
        ...
        <div class="add-parcel">
        	<div class="container">
            	...
            	<center><h1><u>Parcel Information</u> </h1></center>
                
                <form method="post" action="personalAddParcel.php">
                	...
                	<label><b>Name</b></label>
      				...
      				<input type="text" id="phone" placeholder="e.g: 0123456789" name="numphone" required><br />
